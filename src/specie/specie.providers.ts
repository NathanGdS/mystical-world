...
export namespace SPECIE_PROVIDERS {
    ...
    namespace INDEX_SPECIE_USECASE {
        export const values = {
            ...
            useFactory: (specieRepository: ISpecieRepository) => new FindAllSpeciesUseCase(specieRepository),
            inject: [instance]
        }
    }
    ...
    namespace FINDONE_SPECIE_USECASE {
        export const values = {
            ...
            useFactory: (specieRepository: ISpecieRepository) => new FindOneSpecieUseCase(specieRepository),
            inject: [instance]
        }
    }
    ...
    namespace CREATE_SPECIE_USECASE {
        export const values = {
            ...
            useFactory: (specieRepository: ISpecieRepository) => new CreateSpecieUseCase(specieRepository),
            inject: [instance]
        }
    }
    ...
    namespace UPDATE_SPECIE_USECASE {
        export const values = {
            ...
            useFactory: (specieRepository: ISpecieRepository) => new UpdateSpecieUseCase(specieRepository),
            inject: [instance]
        }
    }
    ...
    namespace REMOVE_SPECIE_USECASE {
        export const values = {
            ...
            useFactory: (specieRepository: ISpecieRepository) => new RemoveSpecieUseCase(specieRepository),
            inject: [instance] 
        }
    }
