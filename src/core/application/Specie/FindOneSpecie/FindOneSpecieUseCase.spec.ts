...
import { FindOneSpecieOutPut, FindOneSpecieUseCase } from "./FindOneSpecieUseCase";
...
describe ("FindOneSpecieUseCase", () => {
    ...
    it("Should be able to return a Specie", async () => {
        ...
        const output: FindOneSpecieOutPut = await findOneSpecieUseCase.execute(specie.id)
